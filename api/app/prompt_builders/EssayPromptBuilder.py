...
class EssayPromptBuilder(PromptBuilder):
    def __init__(self):
        super('Redação Dissertativa-Argumentativa')
    ...
    def _buildPrompt(self, sb: StringBuilder, config: UploadConfig):
        ...
        sb.ln(f'- Crie o campo "pontuacao", sendo ele um número decimal de 0 a {PromptBuilder.maxScore}. Defina o valor deste campo de acordo com o quão corretas estão as informações da redação e as regras de gramática;')