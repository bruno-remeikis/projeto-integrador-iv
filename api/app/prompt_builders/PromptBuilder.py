...
class PromptBuilder(ABC):
    ...
    def __init__(self, type, scoringCriteria):
        self.type: str = type
    ...
    def processPrompt(self, prova: str, config: UploadConfig) -> str:
        ...
        sb.ln(f'- Deve ter o campo "pontuacao" recebendo um número decimal de 0 a {PromptBuilder.MAX_SCORE}. {self.scoringCriteria};')
